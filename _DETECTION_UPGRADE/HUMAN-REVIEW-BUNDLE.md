# Human-review bundle — deterministic cue lists (P4-B + P5-C)

**Status: NOT shipped. Held for term-by-term human sign-off before integration.**

These are the only pieces of the detection upgrade that add **deterministic
wordlist/regex** to `safety.ts`. Per the standing rule (suicide-detection
