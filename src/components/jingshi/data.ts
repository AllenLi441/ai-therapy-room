...
export const STR: Record<Lang, Record<string, any>> = {
  zh: {
    ...
    consent_title: "在开始之前", consent_agree: "点「进入」即代表你已阅读并同意以上内容。", consent_enter: "进入",
    about_title: "关于安屿",
    about_who: "安屿是「静室」里陪你的声音——温柔、专注、不评判。以倾听为主，需要时融入稳定化练习和温和的认知视角。",
    about_voice_t: "安屿的声音",
    about_voice: "先把你接住、再陪你慢慢看——不急、不评判、不说教。需要时，我会用具体的话陪你看清想法和情绪，一次只走一小步。",
  ...
  en: {
    ...
    consent_title: "Before we begin", consent_agree: "Tapping “Enter” means you've read and agree to the above.", consent_enter: "Enter",
